...
WHERE dbo.SalesPerson.SalesPersonID = @SalesPersonID
END


EXECUTE TransactionA '10942', 'LOorogan', 'Llpolferin','None', 'BNC', '55 Nrkshire St', 'New York Central', 'Lanhattan', '2011', 'Mogan.podolf619@gmail.com', '(02) 420 548 4555', '10942','Debit Card', 'x0PLmssI99kaLL','6.222', 'Standard', 'None', 'NZ$ 1,000', '2018-12-01 15:27:28', '2021-12-01 19:37:48','102', '2120320';
